...
void DestroyDebugUtilsMessengerEXT(VkInstance instance, VkDebugUtilsMessengerEXT debugUtilsMessenger,
                                   const VkAllocationCallbacks* pAllocator)
{
...
private:
	...
	SwapChainSupportDetails querySwapChainSupport(VkPhysicalDevice device)
	{
		...
		{
			throw std::runtime_error("physical device does not support any surface format");
		}
	...
	void createSwapChain()
	{
		...
		VkPresentModeKHR presentMode = chooseSwapPresentMode(swapChainSupportDetails.presentMode);
